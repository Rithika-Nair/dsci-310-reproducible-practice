...
```{r all-population, fig.cap="Horse populations for all provinces in Canada from 1906 - 1972", out.width="100%", out.height="100%"}
...
Additionally, note that in Table 1 we consider the sample standard deviation of the number of horses during the same time span as Figure \@ref(fig:all-population).

```{r largest-sd-population, fig.cap="Horse populations for the province with the largest standard deviation", out.width="100%", out.height="100%"}
